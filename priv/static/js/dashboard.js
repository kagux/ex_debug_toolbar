...
require.register("chart.js/Chart.js", function(exports, require, module) {
...
var App = function () {
  ...
  _createClass(App, [{
    ...
    key: 'renderRequestsChart',
    value: function renderRequestsChart() {
      var areaChartCanvas = (0, _jquery2.default)('#areaChart').get(0).getContext('2d');
      var areaChart = new _chart2.default(areaChartCanvas);
...
require.alias("chart.js/Chart.js", "chart.js");process = require('process');require.register("___globals___", function(exports, require, module) {
