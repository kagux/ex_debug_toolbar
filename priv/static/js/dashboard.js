...
require.register("admin-lte/dist/js/adminlte.min.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "admin-lte");
  (function() {
    /*! AdminLTE app.js
* ================
...
require.register("web/static/js/dashboard.js", function(exports, require, module) {
'use strict';
...
var App = function () {
  ...
  _createClass(App, [{
    ...
    value: function joinToolbarChannel(socket) {
      ...
      var channel = socket.channel('dashboard:history');
      channel.join().receive("ok", function (resp) {
        _this.logger.debug('Successfully joined channel', resp);
    ...
    key: 'onRequestDeleted',
    value: function onRequestDeleted(data) {
      this.logger.debug('Deleting request', data.uuid);
      (0, _jquery2.default)('#' + data.uuid).remove();
...
require('web/static/js/dashboard');
