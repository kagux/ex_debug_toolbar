...
var _breakpoints_panel = require('./toolbar/breakpoints_panel.js');
...
var App = function () {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      this.breakpointsPanel = new _breakpoints_panel2.default(socket);
    }
  }, {
    key: 'initSocket',
    ...
    value: function joinToolbarChannel(socket) {
      var channel = socket.channel('toolbar:request:' + this.opts.requestId);
    ...
    value: function renderToolbar(_ref) {
      ...
      var toolbar = (0, _jquery2.default)('<div id="ex-debug-toolbar"><div>' + html + '</div></div>');
